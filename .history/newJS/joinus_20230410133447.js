...
function clearInput() {
        ...
        var user = {
           ...
           $.ajax({
             ...
             success(data){
                ...
                generateCard(fullname,age,sex,email);
                clearInput();
             },
             error(err){
              console.log(err);
  ...
  function generateCard(name, age, sex, email) {
    ...
    ctx.fillText("Name: " + name, 350, 160);
    ctx.font = "20px Arial";
    ctx.fillText("Age: " + age, 350, 210);
    ctx.fillText("Sex: " + sex, 350, 260);
    ctx.fillText("Email: " + email, 350, 310);
